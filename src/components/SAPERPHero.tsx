        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-2xl md:text-3xl text-blue-100 leading-relaxed font-medium max-w-4xl mx-auto">
              With QuantaGlobal's Brownfield approach, powered by SARAH AI, you reduce technical debt, clean up what you no longer need, and move confidently to SAP S/4HANA—without starting over.
            </p>
