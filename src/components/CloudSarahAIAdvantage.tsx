        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">SARAH AI</span> Advantage
            </h2>
            
            <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-4xl mx-auto font-medium">
              Our intelligent automation platform, SARAH AI, accelerates your move to SAP S/4HANA Public Cloud by:
            </p>
          </div>
...
export default CloudSarahAIAdvantage;
