...
const FinanceServiceBuckets = () => {
  const services = [
    ...
    {
      title: 'Global Business Services (GBS) + SARAH AI',
      description: 'Build resilient, cost-effective, and AI-enabled service models. With SARAH AI, automate finance processes, reduce errors, and free up teams for strategic priorities.',
      icon: '🤖',
