        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-blue-200 leading-relaxed max-w-4xl mx-auto">
              QuantaGlobal's Transformation Control Tower gives leaders a single vantage point: foresight to see ahead, orchestration to align execution, and intelligence to keep transformation adaptive.
            </p>
