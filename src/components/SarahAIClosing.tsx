        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-4xl mx-auto">
              With SARAH, you move faster, reduce risk, and unlock clarity across your enterprise — from the front office to the back office, and everything in between.
            </p>
          </div>
