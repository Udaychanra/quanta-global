...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="section-padding pt-32 bg-gradient-to-br from-background to-primary/5">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold text-foreground leading-tight">
                  ...
                  <span className="text-gradient"> SAP Has Been Missing</span>
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Finally, SAP support that works the way you do. Not against you.
                </p>
              </div>
              <Button size="lg" className="btn-corporate text-lg px-8 py-4">
            ...
            <div className="flex justify-center">
              <div className="w-96 h-96 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <h3 className="text-2xl font-semibold text-foreground">Endless Hours Wasted</h3>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <h3 className="text-2xl font-semibold text-foreground">Built from Experience</h3>
                </div>
                <p className="text-lg text-muted-foreground">
      ...
      <section className="section-padding bg-accent/20">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">What is SARAH?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-corporate text-center space-y-6">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
                <Zap className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-2xl font-semibold text-foreground">Productivity</h3>
            ...
            <div className="card-corporate text-center space-y-6">
              ...
              <h3 className="text-2xl font-semibold text-foreground">Personality</h3>
              <p className="text-muted-foreground">
            ...
            <div className="card-corporate text-center space-y-6">
              ...
              <h3 className="text-2xl font-semibold text-foreground">Precision</h3>
              <p className="text-muted-foreground">
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto text-center">
            <blockquote className="text-3xl lg:text-4xl font-medium text-foreground leading-relaxed italic">
            ...
            <div className="mt-8 flex items-center justify-center space-x-4">
              ...
              <p className="text-muted-foreground font-medium">The SARAH AI Team</p>
              <div className="w-12 h-0.5 bg-primary"></div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="section-container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Join the Private Beta</h2>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
              ...
              >
                ...
                <Button 
                  type="submit" 
                  size="lg" 
                  className="w-full bg-white text-primary hover:bg-white/90 font-semibold py-4"
                >
                  Request Beta Access
